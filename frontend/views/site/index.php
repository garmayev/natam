        ...
        <div class="container-fluid">
            <div class="form_inner">
                ...
                <div class="forms">
					...
					echo Html::textInput("Client[name]", "", ["placeholder" => "Ваше ФИО", "id" => "ticket-client-name", "required" => true, "value" => $client->name]);
					echo Html::textInput("Client[phone]", "", ["placeholder" => "Ваш номер телефона", "id" => "ticket-client-phone", "required" => true, "value" => $client->phone]);
					echo Html::textInput("Client[email]", "", ["placeholder" => "Ваш E-mail", "type" => "email", "id" => "ticket-client-email", "value" => $client->email]);
